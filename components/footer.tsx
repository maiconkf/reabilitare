export default function Footer() {
  return (
    <footer className="bg-(--color-emerald-800) text-white py-8 border-t border-emerald-700/50">
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 hover:bg-white/20 border border-white/15 text-white text-sm font-medium transition-all duration-300 hover:scale-105"
